...
VERIFY_OK=$(timeout 5 opensc-tool --reader 0 --card-driver default \
...
VERIFY_BAD=$(timeout 5 opensc-tool --reader 0 --card-driver default \
  --send-apdu "00:A4:04:00:06:D2:76:00:01:24:01" \
...
VERIFY_OK2=$(timeout 5 opensc-tool --reader 0 --card-driver default \
  --send-apdu "00:A4:04:00:06:D2:76:00:01:24:01" \
  --send-apdu "00:20:00:83:08:31:32:33:34:35:36:37:38" 2>&1 | tail -5 || true)
...
PUTDATA_OUT=$(timeout 5 opensc-tool --reader 0 --card-driver default \
  --send-apdu "00:A4:04:00:06:D2:76:00:01:24:01" \
